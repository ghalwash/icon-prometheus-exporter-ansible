...
project = u"icon_prometheus_exporter"
copyright = u"2020, Haitham Ghalwash"
author = u"Haitham Ghalwash"
repo_name = u"icon_prometheus_exporter"
...
texinfo_documents = [
    (master_doc, repo_name, u'{} Documentation'.format(repo_name),
     author, repo_name, u'Package to do something useful',
     'Miscellaneous'),
]
